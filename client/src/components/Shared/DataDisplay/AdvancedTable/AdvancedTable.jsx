...
function AdvancedTable({
    ...
    collapsedColumns: controlledCollapsedColumns = null,
    ...
    const {
        ...
        defaultCollapsedColumns:
            defaultCollapsedColumns.length > 0 ? defaultCollapsedColumns : defaultHiddenColumns,
                            ...
                            <colgroup>
                                ...
                                {orderedEffectiveColumns.map((col) => (
                                    <col
                                        key={`col-def-${col.key}`}
                                        style={{
                                            width: collapsedKeys.has(col.key)
                                                ? '52px'
                                                : col.width || '180px',
                                            minWidth: collapsedKeys.has(col.key)
                                                ? '52px'
                                                : col.width || '180px',
                                        }}
                                    />
